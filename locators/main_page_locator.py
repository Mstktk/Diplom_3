...
class MainPageLocator:
    ...
    BUT_CROSS = (By.XPATH, '//button[contains(@class, "Modal_modal__close")]')
    ...
    INGREDIENT_LOCATOR = {
        ...
        'souses': [
            ['souses_1', (By.XPATH, '//a[@href="/ingredient/61c0c5a71d1f82001bdaaa73"]')],
            ['souses_2', (By.XPATH, '//a[@href="/ingredient/61c0c5a71d1f82001bdaaa74"]')],
            ['souses_3', (By.XPATH, '//a[@href="/ingredient/61c0c5a71d1f82001bdaaa75"]')],
            ['souses_4', (By.XPATH, '//a[@href="/ingredient/61c0c5a71d1f82001bdaaa72"]')]
        ],
        'toppings': [
            ['topping_1', (By.XPATH, '//a[@href="/ingredient/61c0c5a71d1f82001bdaaa6f"]')],
