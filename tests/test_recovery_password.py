...
class TestRecoveryPassword:
    ...
    def test_click_recovery_button(self, driver):
        ...
        recovery_password_page.going_page_login()  # Использование актуальной ссылки
        recovery_password_page.click_but_recovery_password()
        recovery_password_page.wait_loading_page_recovery()
        assert recovery_password_page.get_url_page() == Urls.FORGOT_PASSWORD_URL
    ...
    def test_send_email_and_click_recovery(self, driver):
        ...
        assert recovery_password_page.get_url_page() == Urls.RESET_PASSWORD_URL
    ...
    def test_click_but_show_hide_password(self, driver):
        ...
        expected_result = recovery_password_page.get_attribute_field(RecoveryPageLocator.ACTIVE_PASSWORD_FIELD, 'class')
